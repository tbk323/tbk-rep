<template>
  <div>
    <div class="top">
      ...
      <p>
        <el-button class="pur" @click="dialogFormVisible = true"
          ><span class="el-icon-circle-plus"></span> 新增岗位</el-button
        >
      </p>
    </div>
    <div class="tab">
    ...
    <!-- 新增岗位 -->
    <pos :dialogFormVisible="dialogFormVisible" :form="form" @add="add"></pos>
    <!-- 分页 -->
...
import pos from './postcom.vue'
export default {
  components: { pages, pos },
  data() {
    return {
