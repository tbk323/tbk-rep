<template>
  <div>
    <div class="top">
      <p>职级名称：<input type="text" placeholder="请输入姓名" /></p>
      <p>
      ...
      <p>
        <el-button class="pur" @click="dialogFormVisible = true"
          ><span class="el-icon-circle-plus"></span> 新增职级</el-button
        >
      </p>
    </div>
    <div class="tab">
      <el-table :data="tableData" border style="width: 80%">
        ...
        <el-table-column prop="name" label="职级名称" align="center">
        </el-table-column>
        <el-table-column prop="province" label="备注" align="center">
        </el-table-column>
    ...
    <!-- 新增职级-->
    <rank :dialogFormVisible="dialogFormVisible" @add="add" :form="form"></rank>
...
import rank from './rankment.vue'
export default {
  components: { pages, rank },
  data() {
    return {
