<template>
  <div>
    <div class="top">
      <p>材料名称：<input type="text" placeholder="请输入姓名" /></p>
      <p>
      ...
      <p>
        <el-button class="pur" @click="dialogFormVisible = true"
          ><span class="el-icon-circle-plus"></span> 新增材料</el-button
        >
      </p>
    </div>
    <div class="tab">
      <el-table :data="tableData" border style="width: 80%">
        ...
        <el-table-column prop="province" label="材料地址" align="center">
        </el-table-column>
    ...
    <!-- 新增材料 -->
    <cai :dialogFormVisible="dialogFormVisible" :form="form" @add="add"></cai>
    <!-- 分页、 -->
...
import cai from './cailiaoCom.vue'
export default {
  components: { pages, cai },
  data() {
    return {
