  ...
  <div>
    <div class="top">
      <p>
        <el-button class="pur" @click="dialogFormVisible = true"
          ><span class="el-icon-circle-plus"></span> 添加审批流程</el-button
        >
      </p>
    </div>
    <!-- 表格 -->
    <div class="tab">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="address" label="最后修改人"> </el-table-column>
        <el-table-column prop="address" label="最后修改时间"> </el-table-column>
    ...
    <!-- 编辑框 -->
    <flow :dialogFormVisible="dialogFormVisible" :form="form" @add="add"></flow>
  </div>
</template>

<script>
import pages from '../../../components/pages.vue'
import flow from './flowCom.vue'
export default {
